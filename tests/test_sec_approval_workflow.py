...
class LandoAPIDouble:
    ...
    def __call__(
        ...
        if operation.startswith("stacks"):
            ...
            return {}
        elif operation == "requestSecApprovalForCommitMessage":
            # Mock response for the "POST /requestSecApprovalForCommitMessage"
            # operation. Pretend there were no problems.
            return {}
        else:
            raise RuntimeError(
